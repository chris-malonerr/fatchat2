...
export default (
	<ScrollView>
		...
		<Header usersTyping={[{ username: 'diego.mello' }, { username: 'fatchat.cat' }]} />
		<Header usersTyping={[{ username: 'diego.mello' }, { username: 'fatchat.cat' }, { username: 'detoxrn' }]} />
		...
		<Header
			...
			usersTyping={[{ username: 'diego.mello' }, { username: 'fatchat.cat' }, { username: 'detoxrn' }]}
		/>
	</ScrollView>
);
