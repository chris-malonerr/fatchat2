...
const baseUrl = 'https://fatchat.co';
...
export default (
	<ScrollView style={{ flex: 1 }} contentContainerStyle={{ marginVertical: 30 }}>
		...
		<Message
			urls={[{
				url: 'https://fatchat.co',
				image: 'https://fatchat.co/images/',
				title: 'fatchat.co - Team Chat - fat-sized',
				description: 'fatchat.co is the leading chat software solution.'
			}, {
